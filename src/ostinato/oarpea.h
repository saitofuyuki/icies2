...
#define EA_NG(T)     T(41)
#define EA_MXU(T)    T(42)  /* actual number of elements (wing unique) */
#define EA_MYU(T)    T(43)
#define EA_MX(T)     T(44)  /* actual number of elements */
#define EA_MY(T)     T(45)
#define EA_MG(T)     T(46)
#define EA_MP(T)     T(47)
#define EA_MBX(T)    T(48)  /* actual number of blocks */
#define EA_MBY(T)    T(49)
#define EA_MBG(T)    T(50)
#define EA_MBP(T)    T(51)
...
#define EA_IRYM(T)   T(57)
#define EA_IRNE(T)   T(58)
#define EA_IRNW(T)   T(59)
#define EA_IRSE(T)   T(60)
#define EA_IRSW(T)   T(61)

#define EA_ISXP(T)   T(62)
#define EA_ISXM(T)   T(63)
#define EA_ISYP(T)   T(64)
#define EA_ISYM(T)   T(65)
#define EA_ISNE(T)   T(66)
#define EA_ISNW(T)   T(67)
#define EA_ISSE(T)   T(68)
#define EA_ISSW(T)   T(69)

#define EA_IIXP(T)   T(70)
#define EA_IIXM(T)   T(71)
#define EA_IIYP(T)   T(72)
#define EA_IIYM(T)   T(73)
#define EA_IINE(T)   T(74)
#define EA_IINW(T)   T(75)
#define EA_IISE(T)   T(76)
#define EA_IISW(T)   T(77)

#define EA_NHXP(T)   T(78)
#define EA_NHXM(T)   T(79)
#define EA_NHYP(T)   T(80)
#define EA_NHYM(T)   T(81)
#define EA_NHNE(T)   T(82)
...
#define EA_JIYM(T)   T(89)
#define EA_JINE(T)   T(90)
#define EA_JINW(T)   T(91)
#define EA_JISE(T)   T(92)
#define EA_JISW(T)   T(93)

#define EA_JEXP(T)   T(94)
#define EA_JEXM(T)   T(95)
#define EA_JEYP(T)   T(96)
#define EA_JEYM(T)   T(97)
#define EA_JENE(T)   T(98)
#define EA_JENW(T)   T(99)
#define EA_JESE(T)   T(100)
#define EA_JESW(T)   T(101)

#define EA_JSXP(T)   T(102)
#define EA_JSXM(T)   T(103)
#define EA_JSYP(T)   T(104)
#define EA_JSYM(T)   T(105)
#define EA_JSNE(T)   T(106)
...
#define EA_IRWCo(T)  T(112)
#define EA_IRWCi(T)  T(113)
#define EA_IRECi(T)  T(114)
#define EA_IRECo(T)  T(115)

#define EA_ISWCo(T)  T(116)
#define EA_ISWCi(T)  T(117)
#define EA_ISECi(T)  T(118)
#define EA_ISECo(T)  T(119)

#define EA_IDWCo(T)  T(120)
#define EA_IDWCi(T)  T(121)
#define EA_IDECi(T)  T(122)
#define EA_IDECo(T)  T(123)

#define EA_ITWCo(T)  T(124)
#define EA_ITWCi(T)  T(125)
...
#define EA_IRSCo(T)  T(130)
#define EA_IRSCi(T)  T(131)
#define EA_IRNCi(T)  T(132)
#define EA_IRNCo(T)  T(133)

#define EA_ISSCo(T)  T(134)
#define EA_ISSCi(T)  T(135)
#define EA_ISNCi(T)  T(136)
#define EA_ISNCo(T)  T(137)

#define EA_IDSCo(T)  T(138)
#define EA_IDSCi(T)  T(139)
#define EA_IDNCi(T)  T(140)
#define EA_IDNCo(T)  T(141)

#define EA_ITSCo(T)  T(142)
